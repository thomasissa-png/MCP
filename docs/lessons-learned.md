...
| L3 | 2026-07-20 | Après un corrective qui change les events/persona dans functional-specs, les livrables analytics (kpi-framework, tracking-plan) restent figés et deviennent incohérents (events périmés, persona V2 « Karim »). | pattern | P1 | data-analyst / orchestrateur | docs/analytics/kpi-framework.md, docs/analytics/tracking-plan.md | en cours | non-propagé | @reviewer | GATE REPRISE : resync analytics à faire au démarrage Phase 2 (P1-b), puis re-vérif @reviewer C4/C7/G7. |
